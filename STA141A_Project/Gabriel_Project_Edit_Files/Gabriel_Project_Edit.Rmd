...
**[NOT USED] Remaining Meal Cost After SNAP Benefits per year**
```{r}
cleandata%>%
  group_by(county)%>%
...
**[NOT USED] Linear Model (food insecurity ~ diff btwn snap benefits and meal cost)**
```{r}
g1 <- snapdata%>%
...
**Overall Percent Disability per Year**
```{r}
cleandatadisability%>%
  group_by(county)%>%
